...
var NTI11688015 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NTI10826819 = {size: 0,kind: 43,base: null,node: null,finalizer: null};
var NTI10827002 = {size: 0, kind: 18, base: null, node: null, finalizer: null};
...
var NNI10827002 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "a0", len: 0, typ: NTI10826819, name: "a0", sons: null}, 
{kind: 1, offset: "a1", len: 0, typ: NTI10826819, name: "a1", sons: null}]};
NTI10827002.node = NNI10827002;
...
var NNI11688015 = {kind: 2, len: 2, offset: 0, typ: null, name: null, sons: [{kind: 1, offset: "Field0", len: 0, typ: NTI112, name: "Field0", sons: null}, 
{kind: 1, offset: "Field1", len: 0, typ: NTI112, name: "Field1", sons: null}]};
NTI11688015.node = NNI11688015;
...
var state_10827005 = [{a0: 1773455756, a1: 4275166512}];
var utc_instance_11160231 = [null];
var local_instance_11160232 = [null];
var somequotes_11688049 = [{Field0: makeNimstrLit("Wow that\'s a quote!"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("And that\'s another one"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam a porttitor"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("urna. Cras odio leo, efficitur volutpat orci ac, scelerisque consectetur"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("purus. Mauris convallis nisl non diam vulputate sodales sit amet eget ante."), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("Aliquam vestibulum dui sit amet massa suscipit, vitae elementum leo"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("fermentum. Nulla imperdiet mi ligula, vitae feugiat dui vestibulum in."), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("Aliquam augue arcu, facilisis non purus et, malesuada rhoncus orci. Duis sed"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("cursus elit, ut bibendum quam. Aenean volutpat euismod suscipit. Suspendisse"), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("rutrum maximus nulla id maximus. Nam ac facilisis elit, id semper justo."), Field1: makeNimstrLit("baba")}, {Field0: makeNimstrLit("Mauris tincidunt lacus ac mi ultricies euismod. Nunc sed eros nisi."), Field1: makeNimstrLit("baba")}];
...
function aux_write_stack_trace_160038(f_160040) {
  ...
  var result_160041 = [null];
    ...
    L6: do {
      var j_175236 = 0;
      var colontmp__11690114 = 0;
      colontmp__11690114 = (i_160051 - 1);
      var res_11690119 = colontmp__11690114;
      L7: do {
          L8: while (true) {
          if (!(0 <= res_11690119)) break L8;
            j_175236 = res_11690119;
          ...
          function HEX3Aanonymous_10260048(ev_10260050) {
              function wrapper_10260051() {
                ...
                framePtr = F;
                  ...
                  F.line = 74;
                  failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(74, 10) `action != nil` "));
                  }
...
function apply_events_10300073(n_10300075) {
  ...
  framePtr = F;
    ...
    L1: do {
      ...
      var i_10300089 = 0;
      F.line = 104;
      var colontmp__11690165 = 0;
      F.line = 146;
      colontmp__11690165 = (n_10300075.events != null ? n_10300075.events.length : 0);
      F.line = 106;
      var i_11690166 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690166 < colontmp__11690165)) break L3;
            F.line = 146;
            i_10300089 = i_11690166;
            F.line = 147;
            ...
            F.line = 109;
            i_11690166 = addInt(i_11690166, 1);
          }
      } while(false);
    } while(false);
  framePtr = F.prev;
...
function apply_style_900425(n_900427, s_900428) {
  ...
  framePtr = F;
    ...
    L1: do {
      ...
      var i_900621 = 0;
      F.line = 39;
      var colontmp__11690176 = 0;
      F.line = 300;
      colontmp__11690176 = subInt(s_900428.length, 1);
      F.line = 56;
      var res_11690177 = 0;
      L2: do {
        F.line = 57;
          L3: while (true) {
          if (!(res_11690177 <= colontmp__11690176)) break L3;
            F.line = 300;
            i_900621 = res_11690177;
            F.line = 301;
            n_900427.style[s_900428[i_900621]] = s_900428[addInt(i_900621, 1)];
            F.line = 59;
            res_11690177 = addInt(res_11690177, 2);
          }
      } while(false);
    } while(false);
  framePtr = F.prev;
...
function to_dom_10300154(n_10300156, use_attached_node_10300157, kxi_10300158) {
  ...
  BeforeRet: do {
    ...
    F.line = 176;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(176, 12) `result != nil` "));
    }
    ...
    F.line = 183;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(183, 12) `x.renderImpl != nil` "));
    }
    ...
    if (!(!((x_10370022.expanded == null)))) {
    F.line = 187;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(187, 12) `x.expanded != nil` "));
    }
    ...
    break BeforeRet;
      ...
      L1: do {
        ...
        L2: do {
          ...
          var i_11690134 = 0;
          F.line = 104;
          var colontmp__11690135 = 0;
          F.line = 286;
          colontmp__11690135 = (n_10300156.kids != null ? n_10300156.kids.length : 0);
          F.line = 106;
          var i_11690136 = 0;
          L3: do {
            F.line = 107;
              L4: while (true) {
              if (!(i_11690136 < colontmp__11690135)) break L4;
                F.line = 286;
                i_11690134 = i_11690136;
                F.line = 194;
                k_10425016 = n_10300156.kids[chckIndx(i_11690134, 0, (n_10300156.kids != null ? n_10300156.kids.length : 0)+0-1)-0];
                F.line = 195;
                result_10300159.appendChild(to_dom_10300154(k_10425016, use_attached_node_10300157, kxi_10300158));
                F.line = 109;
                i_11690136 = addInt(i_11690136, 1);
              }
          } while(false);
        } while(false);
      } while(false);
    ...
    L5: do {
      ...
      L6: do {
        ...
        var i_11690147 = 0;
        F.line = 39;
        var colontmp__11690148 = 0;
        F.line = 289;
        colontmp__11690148 = subInt((n_10300156.attrs != null ? n_10300156.attrs.length : 0), 2);
        F.line = 56;
        var res_11690149 = 0;
        L7: do {
          F.line = 57;
            L8: while (true) {
            if (!(res_11690149 <= colontmp__11690148)) break L8;
              F.line = 289;
              i_11690147 = res_11690149;
              F.line = 205;
              k_10440001 = n_10300156.attrs[chckIndx(i_11690147, 0, (n_10300156.attrs != null ? n_10300156.attrs.length : 0)+0-1)-0];
              F.line = 290;
              v_10440002 = n_10300156.attrs[chckIndx(addInt(i_11690147, 1), 0, (n_10300156.attrs != null ? n_10300156.attrs.length : 0)+0-1)-0];
              if (!((v_10440002 == null))) {
              F.line = 207;
              ...
              F.line = 59;
              res_11690149 = addInt(res_11690149, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function same_10450072(n_10450074, e_10450075, nesting_10450076) {
  ...
  BeforeRet: do {
    ...
    L3: do {
      ...
      var i_10465024 = 0;
      F.line = 104;
      var colontmp__11690183 = 0;
      F.line = 229;
      colontmp__11690183 = len_9820014(n_10450074);
      F.line = 106;
      var i_11690184 = 0;
      L4: do {
        F.line = 107;
          L5: while (true) {
          if (!(i_11690184 < colontmp__11690183)) break L5;
            F.line = 229;
            i_10465024 = i_11690184;
            ...
            F.line = 109;
            i_11690184 = addInt(i_11690184, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_865229(a_865231, b_865232) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      var i_870083 = 0;
      F.line = 104;
      var colontmp__11690223 = 0;
      F.line = 233;
      colontmp__11690223 = a_865231.length;
      F.line = 106;
      var i_11690224 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690224 < colontmp__11690223)) break L3;
            F.line = 233;
            i_870083 = i_11690224;
            ...
            F.line = 109;
            i_11690224 = addInt(i_11690224, 1);
          }
      } while(false);
    } while(false);
    F.line = 235;
...
function same_attrs_9830879(a_9830881, b_9830882) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      var i_9830906 = 0;
      F.line = 104;
      var colontmp__11690227 = 0;
      F.line = 295;
      colontmp__11690227 = (a_9830881.attrs != null ? a_9830881.attrs.length : 0);
      F.line = 106;
      var i_11690228 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690228 < colontmp__11690227)) break L3;
            F.line = 295;
            i_9830906 = i_11690228;
            ...
            F.line = 109;
            i_11690228 = addInt(i_11690228, 1);
          }
      } while(false);
    } while(false);
    }
...
function eq_10465214(a_10465216, b_10465217, recursive_10465218) {
  ...
  BeforeRet: do {
    ...
    L1: do {
      ...
      var i_10495008 = 0;
      F.line = 104;
      var colontmp__11690215 = 0;
      F.line = 274;
      colontmp__11690215 = len_9820014(a_10465216);
      F.line = 106;
      var i_11690216 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690216 < colontmp__11690215)) break L3;
            F.line = 274;
            i_10495008 = i_11690216;
            ...
            F.line = 109;
            i_11690216 = addInt(i_11690216, 1);
          }
      } while(false);
    } while(false);
    }
    ...
    L6: do {
      ...
      var i_10520008 = 0;
      F.line = 104;
      var colontmp__11690219 = 0;
      F.line = 306;
      colontmp__11690219 = len_9820014(a_10465216);
      F.line = 106;
      var i_11690220 = 0;
      L7: do {
        F.line = 107;
          L8: while (true) {
          if (!(i_11690220 < colontmp__11690219)) break L8;
            F.line = 306;
            i_10520008 = i_11690220;
            ...
            F.line = 109;
            i_11690220 = addInt(i_11690220, 1);
          }
      } while(false);
    } while(false);
    }
  ...
  framePtr = F;
    ...
    L1: do {
      ...
      L2: do {
        ...
        var i_11690233 = 0;
        F.line = 39;
        var colontmp__11690234 = 0;
        F.line = 289;
        colontmp__11690234 = subInt((old_node_10535055.attrs != null ? old_node_10535055.attrs.length : 0), 2);
        F.line = 56;
        var res_11690235 = 0;
        L3: do {
          F.line = 57;
            L4: while (true) {
            if (!(res_11690235 <= colontmp__11690234)) break L4;
              F.line = 289;
              i_11690233 = res_11690235;
              F.line = 325;
              k_10540009 = old_node_10535055.attrs[chckIndx(i_11690233, 0, (old_node_10535055.attrs != null ? old_node_10535055.attrs.length : 0)+0-1)-0];
              F.line = 290;
              __10540010 = old_node_10535055.attrs[chckIndx(addInt(i_11690233, 1), 0, (old_node_10535055.attrs != null ? old_node_10535055.attrs.length : 0)+0-1)-0];
              F.line = 326;
              old_node_10535055.dom.removeAttribute(k_10540009);
              F.line = 59;
              res_11690235 = addInt(res_11690235, 2);
            }
        } while(false);
      } while(false);
    } while(false);
    L5: do {
      ...
      L6: do {
        ...
        var i_11690241 = 0;
        F.line = 39;
        var colontmp__11690242 = 0;
        F.line = 289;
        colontmp__11690242 = subInt((new_node_10535054.attrs != null ? new_node_10535054.attrs.length : 0), 2);
        F.line = 56;
        var res_11690243 = 0;
        L7: do {
          F.line = 57;
            L8: while (true) {
            if (!(res_11690243 <= colontmp__11690242)) break L8;
              F.line = 289;
              i_11690241 = res_11690243;
              F.line = 327;
              k_10540011 = new_node_10535054.attrs[chckIndx(i_11690241, 0, (new_node_10535054.attrs != null ? new_node_10535054.attrs.length : 0)+0-1)-0];
              F.line = 290;
              v_10540012 = new_node_10535054.attrs[chckIndx(addInt(i_11690241, 1), 0, (new_node_10535054.attrs != null ? new_node_10535054.attrs.length : 0)+0-1)-0];
              if (!((v_10540012 == null))) {
              F.line = 329;
              ...
              F.line = 59;
              res_11690243 = addInt(res_11690243, 2);
            }
        } while(false);
      } while(false);
    } while(false);
...
function remove_all_event_handlers_10187436(d_10187438) {
  ...
  framePtr = F;
    ...
    L1: do {
      ...
      var i_10190041 = 0;
      F.line = 104;
      var colontmp__11690248 = 0;
      F.line = 96;
      colontmp__11690248 = d_10187438.karaxEvents.length;
      F.line = 106;
      var i_11690249 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690249 < colontmp__11690248)) break L3;
            F.line = 96;
            i_10190041 = i_11690249;
            F.line = 97;
            d_10187438.removeEventListener(d_10187438.karaxEvents[i_10190041]["Field0"], d_10187438.karaxEvents[i_10190041]["Field1"]);
            F.line = 109;
            i_11690249 = addInt(i_11690249, 1);
          }
      } while(false);
    } while(false);
    }
...
function diff_10600215(new_node_10600217, old_node_10600218, parent_10600219, current_10600220, kxi_10600221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      F.line = 487;
      failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(487, 12) `oldNode.kind == newNode.kind` "));
      }
      ...
      L7: do {
        ...
        var i_10630024 = 0;
        F.line = 66;
        var colontmp__11690190 = 0;
        F.line = 511;
        colontmp__11690190 = subInt(pos_10630018, 1);
        F.line = 77;
        var res_11690191 = common_prefix_10620202;
        L8: do {
          F.line = 78;
            L9: while (true) {
            if (!(res_11690191 <= colontmp__11690190)) break L9;
              F.line = 511;
              i_10630024 = res_11690191;
              F.line = 512;
              ...
              F.line = 80;
              res_11690191 = addInt(res_11690191, 1);
            }
        } while(false);
      } while(false);
      ...
      L10: do {
        ...
        var i_10630030 = 0;
        F.line = 77;
        var res_11690197 = pos_10630018;
        L11: do {
          F.line = 78;
            L12: while (true) {
            if (!(res_11690197 <= new_pos_10620215)) break L12;
              F.line = 515;
              i_10630030 = res_11690197;
              F.line = 516;
              add_patch_10550414(kxi_10600221, 2, current_10600220, null, HEX5BHEX5D_9820036(new_node_10600217, i_10630030), null);
              F.line = 80;
              res_11690197 = addInt(res_11690197, 1);
            }
        } while(false);
      } while(false);
      }
        ...
        L13: do {
          ...
          var i_10630037 = 0;
          F.line = 77;
          var res_11690203 = pos_10630018;
          L14: do {
            F.line = 78;
              L15: while (true) {
              if (!(res_11690203 <= new_pos_10620215)) break L15;
                F.line = 519;
                i_10630037 = res_11690203;
                F.line = 520;
                add_patch_10550414(kxi_10600221, 3, current_10600220, before_10630031, HEX5BHEX5D_9820036(new_node_10600217, i_10630037), null);
                F.line = 80;
                res_11690203 = addInt(res_11690203, 1);
              }
          } while(false);
        } while(false);
      }
      ...
      L16: do {
        ...
        var i_10630043 = 0;
        F.line = 77;
        var res_11690209 = pos_10630018;
        L17: do {
          F.line = 78;
            L18: while (true) {
            if (!(res_11690209 <= old_pos_10620214)) break L18;
              F.line = 522;
              i_10630043 = res_11690209;
              F.line = 523;
              ...
              F.line = 80;
              res_11690209 = addInt(res_11690209, 1);
            }
        } while(false);
      } while(false);
      break;
    ...
    case 4:
      if (true) {
      F.line = 529;
      failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(529, 26) `false` eq returned usenewNode"));
      }
...
function move_dom_10560047(dest_10560049, src_10560050) {
  ...
  framePtr = F;
    ...
    F.line = 390;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(390, 10) `dest.len == src.len` "));
    }
    ...
    L1: do {
      ...
      var i_10575208 = 0;
      F.line = 104;
      var colontmp__11690260 = 0;
      F.line = 391;
      colontmp__11690260 = len_9820014(dest_10560049);
      F.line = 106;
      var i_11690261 = 0;
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690261 < colontmp__11690260)) break L3;
            F.line = 391;
            i_10575208 = i_11690261;
            F.line = 392;
            move_dom_10560047(HEX5BHEX5D_9820036(dest_10560049, i_10575208), HEX5BHEX5D_9820036(src_10560050, i_10575208));
            F.line = 109;
            i_11690261 = addInt(i_11690261, 1);
          }
      } while(false);
    } while(false);
  framePtr = F.prev;
  ...
  framePtr = F;
    L1: do {
      ...
      L2: do {
        F.line = 107;
          L3: while (true) {
          if (!(i_11690254 < kxi_10575224.patchLen)) break L3;
            F.line = 395;
            i_10575232 = i_11690254;
            F.line = 396;
            ...
            F.line = 109;
            i_11690254 = addInt(i_11690254, 1);
          }
      } while(false);
    } while(false);
    F.line = 425;
    ...
    L4: do {
      ...
      L5: do {
        F.line = 107;
          L6: while (true) {
          if (!(i_11690257 < kxi_10575224.patchLenV)) break L6;
            F.line = 426;
            i_10585013 = i_11690257;
            F.line = 427;
            ...
            F.line = 429;
            failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(429, 12) `p.newChild.dom != nil` "));
            }
            
            F.line = 109;
            i_11690257 = addInt(i_11690257, 1);
          }
      } while(false);
    } while(false);
    F.line = 430;
...
function dodraw_10715262(kxi_10715264) {
  ...
  BeforeRet: do {
    ...
    replace_by_id_10465074(kxi_10715264.rootId, asdom_10715285);
      ...
      F.line = 644;
      failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(644, 14) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
      }
    ...
    if (!(same_10450072(kxi_10715264.currentTree, document.getElementById(kxi_10715264.rootId), 0))) {
    F.line = 657;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/Crash/200728-Nimble/karax/karax.nim(657, 12) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
    }
  ...
  framePtr = F;
    ...
    L1: do {
      ...
      L2: do {
        F.line = 4;
          L3: while (true) {
          if (!(i_11690274 < (kids_9830449 != null ? kids_9830449.length : 0))) break L3;
            F.line = 267;
            k_9830481 = kids_9830449[chckIndx(i_11690274, 0, (kids_9830449 != null ? kids_9830449.length : 0)+0-1)-0];
            F.line = 267;
            add_9820072(result_9830450, k_9830481);
            F.line = 6;
            i_11690274 = addInt(i_11690274, 1);
          }
      } while(false);
    } while(false);
  framePtr = F.prev;
...
function epoch_time_11685401() {
  var result_11685403 = 0.0;

  var F={procname:"times.epochTime",prev:framePtr,filename:"times.nim",line:0};
  framePtr = F;
    F.line = 2591;
    result_11685403 = HEX2F_325648(new Date().getTime(), 1000);
  framePtr = F.prev;

  return result_11685403;

}
function rotl_10827230(x_10827232, k_10827233) {
  var result_10827234 = 0;

  var F={procname:"random.rotl",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 122;
    result_10827234 = ((x_10827232 << k_10827233) | ((x_10827232 >>> 0) >>> ((64 - k_10827233) >>> 0)));
  framePtr = F.prev;

  return result_10827234;

}
function next_10827258(r_10827261) {
  var result_10827262 = 0;

  var F={procname:"random.next",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 139;
    var s0_10827263 = r_10827261.a0;
    F.line = 140;
    var s1_10827264 = r_10827261.a1;
    F.line = 141;
    result_10827262 = ((s0_10827263 + s1_10827264) >>> 0);
    F.line = 142;
    s1_10827264 = (s1_10827264 ^ s0_10827263);
    F.line = 143;
    r_10827261.a0 = ((rotl_10827230(s0_10827263, 55) ^ s1_10827264) ^ (s1_10827264 << 14));
    F.line = 144;
    r_10827261.a1 = rotl_10827230(s1_10827264, 36);
  framePtr = F.prev;

  return result_10827262;

}
function init_rand_10830612(seed_10830614) {
  var result_10830615 = [{a0: 0, a1: 0}];

  var F={procname:"random.initRand",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    if (!(!((seed_10830614 == 0)))) {
    F.line = 572;
    failed_assert_impl_102680(makeNimstrLit("/mnt/DATA/home/zorzi/.choosenim/toolchains/nim-1.2.0/lib/pure/random.nim(572, 12) `seed != 0` "));
    }
    
    F.line = 573;
    result_10830615[0].a0 = (seed_10830614 >> 16);
    F.line = 574;
    result_10830615[0].a1 = (seed_10830614 & 65535);
    F.line = 575;
    next_10827258(result_10830615[0]);
  framePtr = F.prev;

  return result_10830615[0];

}
function randomize_10845222(seed_10845224) {
  var F={procname:"random.randomize",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 593;
    nimCopy(state_10827005[0], init_rand_10830612(seed_10845224), NTI10827002);
  framePtr = F.prev;

  
}
function randomize_11687001() {
  var F={procname:"random.randomize",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 645;
    var time_11687203 = ((epoch_time_11685401() * 1.0000000000000000e+03) & 2147483647);
    F.line = 646;
    randomize_10845222(time_11687203);
  framePtr = F.prev;
...
function rand_10830243(r_10830246, max_10830247) {
  var result_10830248 = 0;
  ...
  BeforeRet: do {
    ...
    L1: do {
      F.line = 248;
        ...
        if (!true) break L2;
          F.line = 249;
          var x_10830249 = next_10827258(r_10830246);
          if ((x_10830249 <= ((4294967295 - (4294967295 % max_10830247)) >>> 0))) {
          F.line = 251;
          result_10830248 = chckRange((x_10830249 % ((max_10830247 + 1) )), -2147483648, 2147483647);
          break BeforeRet;
          }
  ...
  return result_10830248;

}
function rand_11688153(r_11688156, x_11688158) {
  var result_11688159 = 0;

  var F={procname:"rand.rand",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 339;
    result_11688159 = addInt(rand_10830243(r_11688156, chckRange(subInt(x_11688158.b, x_11688158.a), 0, 2147483647)), x_11688158.a);
  framePtr = F.prev;

  return result_11688159;

}
function rand_11688128(x_11688132) {
  var result_11688133 = 0;

  var F={procname:"rand.rand",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 363;
    result_11688133 = rand_11688153(state_10827005[0], x_11688132);
  framePtr = F.prev;

  return result_11688133;
...
function sample_11688084(a_11688088) {
  var result_11688089 = {Field0: null, Field1: null};

  var F={procname:"sample.sample",prev:framePtr,filename:"random.nim",line:0};
  framePtr = F;
    F.line = 482;
    nimCopy(result_11688089, a_11688088[chckIndx(rand_11688128(HEX2EHEX2E_2065220(0, (a_11688088 != null ? (a_11688088.length-1) : -1))), 0, (a_11688088 != null ? a_11688088.length : 0)+0-1)-0], NTI11688015);
  framePtr = F.prev;

  return result_11688089;

}
function get_quote_11688078() {
  var F={procname:"app.getQuote",prev:framePtr,filename:"app.nim",line:0};
  framePtr = F;
    F.line = 19;
    var quote_11688080 = document.querySelector(".QuoteDisplay");
    F.line = 20;
    var author_11688081 = document.querySelector("#author");
    F.line = 22;
    randomize_11687001();
    F.line = 24;
    var rq_11688241 = sample_11688084(somequotes_11688049);
    F.line = 26;
    quote_11688080.innerHTML = toJSStr(rq_11688241.Field0);
    F.line = 27;
    author_11688081.innerHTML = toJSStr(rq_11688241.Field1);
  framePtr = F.prev;

  
}
function main_11688270() {
  var result_11688272 = null;

  var F={procname:"app.main",prev:framePtr,filename:"app.nim",line:0};
  framePtr = F;
    F.line = 30;
    F.line = 30;
    var tmp_11688309 = tree_9830445(43, []);
    F.line = 31;
    var tmp_11688310 = tree_9830445(16, []);
    F.line = 32;
    var tmp_11688311 = tree_9830445(43, []);
    F.line = 32;
    tmp_11688311.class = "content-box";
    F.line = 33;
    var tmp_11688317 = tree_9830445(43, []);
    F.line = 33;
    tmp_11688317.class = "logo";
    F.line = 34;
    add_9820072(tmp_11688317, text_9830548(makeNimstrLit("nim")));
    F.line = 34;
    add_9820072(tmp_11688311, tmp_11688317);
    F.line = 35;
    var tmp_11688318 = tree_9830445(43, []);
    F.line = 35;
    tmp_11688318.class = "Quote-box";
    F.line = 36;
    var tmp_11688319 = tree_9830445(21, []);
    F.line = 36;
    tmp_11688319.class = "Quote";
    F.line = 37;
    add_9820072(tmp_11688319, text_9830548(makeNimstrLit("Random Quote Generator")));
    F.line = 37;
    add_9820072(tmp_11688318, tmp_11688319);
    F.line = 38;
    var tmp_11688320 = tree_9830445(24, []);
    F.line = 38;
    tmp_11688320.class = "QuoteDisplay";
    F.line = 39;
    add_9820072(tmp_11688320, text_9830548(makeNimstrLit("Quote display")));
    F.line = 39;
    add_9820072(tmp_11688318, tmp_11688320);
    F.line = 41;
    var tmp_11688321 = tree_9830445(31, []);
    F.line = 41;
    tmp_11688321.id = "author";
    F.line = 42;
    add_9820072(tmp_11688321, text_9830548(makeNimstrLit("author")));
    F.line = 42;
    add_9820072(tmp_11688318, tmp_11688321);
    F.line = 44;
    var tmp_11688322 = tree_9830445(106, []);
    F.line = 44;
    tmp_11688322.id = "btn";
    F.line = 44;
    add_event_handler_10750154(tmp_11688322, 0, get_quote_11688078, kxi_10187284[0]);
    F.line = 45;
    add_9820072(tmp_11688322, text_9830548(makeNimstrLit("Click me!")));
    F.line = 45;
    add_9820072(tmp_11688318, tmp_11688322);
    F.line = 45;
    add_9820072(tmp_11688311, tmp_11688318);
    F.line = 45;
    add_9820072(tmp_11688310, tmp_11688311);
    F.line = 45;
    add_9820072(tmp_11688309, tmp_11688310);
    result_11688272 = tmp_11688309;
  framePtr = F.prev;

  return result_11688272;

}
set_renderer_10745238(main_11688270, "ROOT", null);
